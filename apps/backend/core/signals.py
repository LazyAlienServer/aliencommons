...
@receiver(post_save, sender="articles.PublishedArticle")
def create_published_article_content_target(sender, instance, created, **kwargs):
    if created:
        get_or_create_published_article_target(instance)
